...
def cats(list):
    ...
    def get_life_span(item):
        nonlocal total_lifespan_min, total_lifespan_max
        print(f"L'espérance de vie du chat est de : {item['life_span']}")
        split = item['life_span'].split("-")
        total_lifespan_min += int(split[0])
        total_lifespan_max += int(split[1])
        return total_lifespan_min, total_lifespan_max
